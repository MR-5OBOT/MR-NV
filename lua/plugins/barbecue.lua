return {
    ...
    opts = {
        exclude_filetypes = {
            "dashboard", "neo-tree", "TelescopePrompt", "NvimTree", "help", "lazy",
            "sh", "bash", "zsh", "fish", -- Shell scripts
            "markdown", "md",            -- Markdown files
            "text", "txt",               -- Plain text files
            "gitcommit", "gitrebase",    -- Git-related buffers
            "json", "yaml",              -- Data files
            "csv", "xml",                -- Markup/data files
            "git", "hg",                 -- Version control
            "qf", "loclist",             -- Quickfix and location list
