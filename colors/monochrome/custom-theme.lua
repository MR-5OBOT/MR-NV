...
function M.highlight(group, color)
  if color.link then
    ...
    local style = color.style and "gui=" .. color.style
      or color.preserve and ""
      or " gui=NONE cterm=NONE"
    local fg = color.fg and "guifg=" .. color.fg
      or color.preserve and ""
      or "guifg=NONE ctermfg=NONE"
    local bg = color.bg and "guibg=" .. color.bg
      or color.preserve and ""
      or "guibg=NONE ctermbg=NONE"
...
function M.load_plugin_syntax()
  local plugin_syntax = {
    ...
    LspDiagnosticsUnderlineWarning = {
      bg = colors.bg,
      style = "undercurl",
      sp = colors.faded_yellow,
    },
    LspDiagnosticsUnderlineInformation = {
      bg = colors.bg,
      style = "undercurl",
      sp = colors.faded_blue,
    },
